...
export interface Translations {
  ...
  status: {
    ...
    manualMode: string;
    scheduleNow: string;
    holidayModeActive: string;
    manualOverrideActive: string;
    autoHolidayNote: string;
    markTodayHoliday: string;
    holidayOn: string;
    holidayOff: string;
    scheduleWeekdayWork: string;
    scheduleCoffee: string;
    scheduleLunch: string;
    scheduleAvailability: string;
    scheduleSleeping: string;
    scheduleWeekend: string;
    scheduleHoliday: string;
  };
  career: {
    sectionLabel: string;
    fullTimeline: string;
